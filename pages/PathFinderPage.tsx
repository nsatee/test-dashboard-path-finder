  ...
  return (
    <div className="min-h-screen bg-[var(--color-background)] p-4 md:p-8 space-y-8 animate-in fade-in duration-500 pb-20">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <h1 className="text-3xl font-bold tracking-tight text-card-foreground">Path Finder Analytics</h1>
            <p className="text-muted-foreground mt-1">Discover patterns and improve your decision quality.</p>
        </div>
